...
// Remove the first element if the array exists because we are already displaying the elemnt, that is the page.
const removedFirstElement = similarPost?.slice(1) || [];
